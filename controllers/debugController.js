...
exports.index = function (req, res) {
    ...
    //var Request = unirest.get('http://www.gamestar.de').end(function (response) {

    //    //console.log(response.body);
    //    res.render('debug', { body: response.body.replace('<head>', '<head><base href="http://www.gamestar.de" target="_blank">') });
    //});
